...
- ROI по годам (каждый год отдельно, 200K): risk 100% → +233/+312/+438/+279%
- Конечный капитал (реинвест): 200K → 2.72M (risk 100%), 5.32M (risk 200%)
### Verified
- dayofweek — единственный подтверждённый edge (все проверки аудита ✅)
- Si отброшен (6 дней за 4 года — редкие экстремумы рубля)
- OI NG дотюнен (hold120/stop3.5) → CAGR 23% (слабый диверсификатор)
### Changed
- Скрипт: scripts/bt_oi_all_tickers.py (свип OI по тикерам)
- Checkpoint: checkpoint/232-dayofweek-audit-clean.md
