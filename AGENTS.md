...
**Последний чекпойнт: 199 (2026-07-31)** — Честный портфель после фиксов багов, +39.6% ROI, MDD 5.8%
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| ⚡ **IR** | **LKOH** (Лукойл) | **5m** | **25%** | **+8K** | — | **100%** |
| ⚡ **IR** | **SNGP** (Сургут-п) | **5m** | **25%** | **+14K** | **21.3** | **83%** |
| 🐉 **Dragon** | **GD** | **10m** | **35%** | **+58K** | **2.93** | **56%** |
| 🐉 **Dragon** | **NG** | **3m** | **35%** | **+39K** | **1.33** | **41%** |
| **ПОРТФЕЛЬ** | **4 тикера** | **common pool** | — | **+39.6%** | — | **5.8%** ✅ |
