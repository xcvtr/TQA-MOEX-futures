...
**Последний чекпойнт: 222 (2026-08-09)** — Новая стратегия: **базис-арбитраж Si/Eu/CNY ↔ перпетуалы (USDRUBF/EURRUBF/CNYRUBF)**. КСУР-ГО в 16× меньше полного → SHORT-only z>1.5 + ТРИЗ (фильтр ср/чт/пт, risk 6%, lots 30-50): **CAGR 59-72%, DD 12-17%, Calmar 4.3-4.8**. Портфель OI+BA (общий капитал, ПОСЛЕ аудита): **risk=8% pyr=1 lots≤1000 → CAGR 1550%, MTM 13%, Calmar 119**; risk=5% pyr=2 → CAGR 1830%, MTM 17%. Аудит исправил 3 бага: look-ahead базиса (+17%), пирамидинг без маржи, MTM по close (→lo/hi). Пирамидинг потерял привлекательность (pyr=1 лучший по Calmar). Компаунд микро-капитала; реалистично OI 60-220%/год. Ликвидность: mt5 vol = tick_volume, реальные объёмы AlgoPack в 10-50× (BR 631K/день). Реопт OI с MTM-фильтром ≤20%. **Live-исполнение = MT5 (FINAM) или Finam API — мост ещё писать.** Скрипты: `scripts/basis_arb/`. **Базис НЕ в live.** Ранее: чекп.221 — OI NG/BR/SV live-эдж (MC p=0.0000, 60-220%/год, MDD 13-29%).
