...
**Последний чекпойнт: 202 (2026-07-31)** — Портфель с Retest, +243% ROI, MDD 16%
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| 🎯 **Retest** | **Si** | **H1** | **35%** | **+94K** | **617** | **86%** |
| 🎯 **Retest** | **BR** | **H1** | **35%** | **+83K** | **991** | **91%** |
| 🐉 **Dragon** | **GD** | **10m** | **40%** | **+134K** | **3.51** | **55%** |
| 🐉 **Dragon** | **BR** | **10m** | **40%** | **+95K** | **1.49** | **44%** |
| 🎯 Retest | GD | H1 | 35% | +24K | 35.5 | 67% |
| ⚡ IR | ROSN/SNGR/RTKM/LKOH/... | — | 25% | +95K | — | — |
| **ПОРТФЕЛЬ** | **15 стратегий** | **common pool** | — | **+243%** | — | **16.1%** ✅ |
