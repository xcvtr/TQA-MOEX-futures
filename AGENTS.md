...
**Последний чекпойнт: 225 (2026-08-14)** — LIVE=PG (CH изолирован для бэктестов), Docker-воркер, исслед. стратегии отброшены
...
## 🚨 ВЕРИФИКАЦИЯ ИССЛЕДОВАТЕЛЬСКИХ СТРАТЕГИЙ (14.08.2026) — ВСЕ ОТБРОШЕНЫ
