...
**Последний чекпойнт: 214 (2026-08-07)** — TZ-баг найден (futoi MSK vs цены IRK, сдвиг +5ч). Пересмотр: работает ТОЛЬКО SV (oi contrarian, thr 3, risk 10%): 2025 +25%, 2026 +275%, MDD ≤ 20%. RN/TATN/BR/NG/Si/Eu — убыточны (прошлые 60-67% WR — артефакт TZ)
