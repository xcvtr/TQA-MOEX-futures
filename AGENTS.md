...
**Последний чекпойнт: 223 (2026-08-11)** — TZ-аудит: бэктест включал 52% ночных сигналов (не в live), честный пересчёт + НОВЫЙ КОНФИГ: **стоп-лосс 1.5% + pyr5 pct0.3 + risk15% + лимиты лотов сняты → CAGR +920%, MTM DD 13.7%, Calmar 67** (было MDD 50% без стопа). PG обновлён (thr3, exit1.5, stop1.5, max_pos5). Ранее: ПГО формула med×kpur/ksur (ROI +1801% с ПГО), live реинвест. Мост MT5/Finam ещё писать.
