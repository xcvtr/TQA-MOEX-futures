...
**Последний чекпойнт: 201 (2026-07-31)** — Портфель 12 тикеров, +92.8% ROI, MDD 18.4%
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| 🐉 **Dragon** | **GD** | **10m** | **40%** | **+76K** | **3.24** | **56%** |
| 🐉 **Dragon** | **NG** | **3m** | **40%** | **+17K** | **1.31** | **44%** |
| 🐉 **Dragon** | **BR** | **10m** | **40%** | **+62K** | **1.48** | **44%** |
| ⚡ **IR** | **ROSN** | **15m** | **25%** | **+21K** | **7.14** | **66%** |
| ⚡ **IR** | **SNGR** | **5m** | **25%** | **+5.6K** | **1.90** | **67%** |
| ⚡ **IR** | **RTKM** | **5m** | **25%** | **+1.4K** | **4.36** | **82%** |
| ⚡ **IR** | LKOH/SNGP/TATN/MTSI/HANG/HYDR | — | 25% | +42K | — | — |
| **ПОРТФЕЛЬ** | **12 тикеров** | **common pool** | — | **+92.8%** | — | **18.4%** ✅ |
