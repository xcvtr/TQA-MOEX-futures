...
**Последний чекпойнт: 204 (2026-08-02)** — OI-стратегия BR+NG, +5,048% ROI, MDD 17.7% (risk 4.5%, slip 2, полные данные май-июнь докачаны)
...
| **ПОРТФЕЛЬ OI** | **2 тикера** | **физ продают→long, 120 мин** | 4.5% | **+5,048%** | — | **17.7%** ✅ |
