...
**Последний чекпойнт: 196 (2026-07-31)** — IR MIX + Dragon GD + NG, +285% ROI, MDD 17.5%
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| ⚡ **IR** | **MIX** (Индекс Мосбиржи) | **15m** | **15%** | **+208K** | **2.63** | **~9%** |
| 🐉 **Dragon** | **GD** | **10m** | **20%** | **+259K** | **3.35** | **~11%** |
| 🐉 **Dragon** | **NG** | **3m** | **20%** | **+244K** | **1.64** | **~7%** |
| **ПОРТФЕЛЬ** | **3 тикера** | **common pool** | — | **+285%** | — | **17.5%** ✅ |
