...
**Последний чекпойнт: 203 (2026-08-01)** — OI-стратегия BR+NG, +1,536% ROI, MDD 9.4% (risk 3%, slippage 2, весь день)
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| 🎯 **OI** | **BR** | весь день 15-23 | 3% | **+892%** | 3.17 | 72% |
| 🎯 **OI** | **NG** | весь день 15-23 | 3% | **+1,981%** | 3.08 | 65% |
| **ПОРТФЕЛЬ OI** | **2 тикера** | **физ продают→long, 120 мин** | 3% | **+1,536%** | — | **9.4%** ✅ |
...
### 🤖 Paper Trader
- **OI (новый):** `strategies/oi/paper_trader.py` — BR/NG, физ продают→long 120 мин, risk 3%, cron `*/5 15-23`, state `paper_state_oi`
