...
**Последний чекпойнт: 222 (2026-08-09)** — Новая стратегия: **базис-арбитраж Si/Eu/CNY ↔ перпетуалы (USDRUBF/EURRUBF/CNYRUBF)**. КСУР-ГО в 16× меньше полного → SHORT-only z>1.5 + ТРИЗ (фильтр ср/чт/пт, risk 6%, lots 30-50): **CAGR 59-72%, DD 12-17%, Calmar 4.3-4.8**. ROI последний год **47-49%**. ТРИЗ: 2/7 идей сработали (дни недели, риск/лоты); futoi/M15/TP/ЦБ/Si-Eu — отброшены с проверкой. AlfaForex отброшен (своп −500, нет lead-lag). Скрипты: `scripts/basis_arb/`. **НЕ в live — ждёт решения.** Ранее: чекп.221 — OI NG/BR/SV единственный live-эдж (MC p=0.0000, OOS плюс; реалистично 60-220%/год, MDD 13-29%).
