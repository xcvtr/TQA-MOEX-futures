...
**Последний чекпойнт: 207 (2026-08-02)** — OI: BR+NG+SV+RN, **risk 40%**, +1,199%/год ROI, MTM DD 14.7% (КСУР-ПГО ГО, ролл-фильтр, размазывание K=400)
...
| **ПОРТФЕЛЬ OI** | **4 тикера** | **физ продают→long, 60 мин, ролл-фильтр** | 40% | **+1,199%/год** | — | **14.7%** ✅ |
...
- **OI (единственная enabled):** `strategies/oi/prod/engine.py` (плагин) + `fetch_day_net()` в common. **BR/NG/SV/RN**, thr -3%, long 60 мин, **risk 40%**, trailing/SL отключены (0.99). **+1,199%/год ROI, MTM DD 14.7%** (КСУР-ПГО ГО, ролл-фильтр, размазывание по стакану K=400)
