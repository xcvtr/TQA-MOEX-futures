...
**Последний чекпойнт: 215 (2026-08-07)** — Пирамидинг (max_positions 3) + комплементарный портфель NG/BR/SV (risk 0.25/0.25/0.15): 2024 +269%, 2025 +957%, 2026 +595%, MDD ≤ 27%. NG/BR работают в спокойные годы, SV — в краши. TZ-баг: futoi MSK vs цены IRK (+5ч)
