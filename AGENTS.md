...
**Параметры:** фиксированные контракты из PG, комиссия 4×2 RUB, RiskManager (DD-stop 20%, max 5 concurrent)

```
Капитал: 100,000 → 2,216,842 RUB (+2,117%)
MDD: 33.5% | Сделок: 228 | WR: 62.7% | Calmar: 63.2
```
