...
**Последний чекпойнт: 216 (2026-08-07)** — Аудит live: 6 багов исправлено (day_net формула, стоп, expiry, вечерняя сессия, is_roll_day, комиссия fee×contracts). Реалистично: портфель NG/BR/SV thr 4.0 risk 0.25/0.25/0.15 pyr3 → 2024 +81%, 2025 +207%, 2026 +369% (~220%/год, MDD ≤ 25%)
