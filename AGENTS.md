...
**Последний чекпойнт: 197 (2026-07-31)** — ALLFUT портфель LKOH+SNGP IR + GD+NG, +211% ROI, MDD 10.4%
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| ⚡ **IR** | **LKOH** (Лукойл) | **5m** | **15%** | **+5K** | **2.67** | **~63%** |
| ⚡ **IR** | **SNGP** (Сургут-п) | **5m** | **15%** | **+3K** | **1.63** | **~74%** |
| 🐉 **Dragon** | **GD** | **10m** | **20%** | **+219K** | **3.55** | **~56%** |
| 🐉 **Dragon** | **NG** | **3m** | **20%** | **+234K** | **1.72** | **~47%** |
| **ПОРТФЕЛЬ** | **4 тикера** | **common pool** | — | **+211%** | — | **10.4%** ✅ |
