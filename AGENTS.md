...
**Последний чекпойнт: 204 (2026-08-02)** — OI-стратегия BR+NG, +5,905% ROI, MDD 14.3% (risk 4.5%, slippage 2, весь день)
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| 🎯 **OI** | **BR** | весь день 15-23 | 4.5% | **+892%** | 3.17 | 72% |
| 🎯 **OI** | **NG** | весь день 15-23 | 4.5% | **+1,981%** | 3.08 | 65% |
| **ПОРТФЕЛЬ OI** | **2 тикера** | **физ продают→long, 120 мин** | 4.5% | **+5,905%** | — | **14.3%** ✅ |
...
### 🤖 Paper Trader
- **OI (новый):** `strategies/oi/paper_trader.py` — BR/NG, физ продают→long 120 мин, risk 4.5%, cron `*/5 15-23`, state `paper_state_oi`
