...
**Последний чекпойнт: 204 (2026-08-02)** — OI-стратегия BR+NG, +536% ROI, MDD 8.2% (risk 4.5%, slip 2, ЧЕСТНЫЙ бэктест после фикса таймзоны)
...
| **ПОРТФЕЛЬ OI** | **2 тикера** | **физ продают→long, 120 мин** | 4.5% | **+536%** | — | **8.2%** ✅ |
