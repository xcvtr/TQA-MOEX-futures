...
**Последний чекпойнт: 217 (2026-08-08)** — Верификация: IR Si / SH RN / Dragon GD — АРТЕФАКТЫ (разреженные mt5_bars + in-sample, фейки). **OI NG/BR/SV — ЕДИНСТВЕННЫЙ реальный edge** (воспроизводится ±5%, OOS 2021-23 плюс, MC p=0.0015, 19K сделок; реалистично 60-220%/год, MDD 13-29%, профит концентрирован в волатильные годы). Vol-фильтр НЕ улучшает (corr vol↔pnl = 0), сезонный фильтр тоже ОПРОВЕРГНУТ (MDD не снижается, ROI −21-24%). Watchdog: 2 бага починены. US-индексы — нет edge, NVDA — слабая зацепка.

**🚨 Live: только OI (BR/NG/SV) enabled — верно. IR/Dragon/SH/oi_dom — disabled.**
