...
**Последний чекпойнт: 198 (2026-07-31)** — ALLFUT портфель risk 45/55%, +633% ROI, MDD 14.3%
...
|:----------|:------|:------:|:----:|:---:|:--:|:---:|
| ⚡ **IR** | **LKOH** (Лукойл) | **5m** | **45%** | **+52K** | **4.04** | **~65%** |
| ⚡ **IR** | **SNGP** (Сургут-п) | **5m** | **45%** | **+22K** | **1.74** | **~60%** |
| 🐉 **Dragon** | **GD** | **10m** | **55%** | **+786K** | **2.59** | **~50%** |
| 🐉 **Dragon** | **NG** | **3m** | **55%** | **+446K** | **1.60** | **~45%** |
| **ПОРТФЕЛЬ** | **4 тикера** | **common pool** | — | **+633%** | — | **14.3%** ✅ |
