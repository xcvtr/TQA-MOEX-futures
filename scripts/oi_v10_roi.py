...
"""ROI по годам для risk 30/20 pyr2 и pyr3 (LONG+SHORT, ОИ-выход)."""
import sys, bisect
...
def run(risk_ng, risk_small, pyr, pyra_pct):
...
for rng, rsm, pyr, pp, label in [
    (0.30, 0.20, 2, 0.5, "risk 30/20 pyr2"),
    (0.30, 0.20, 3, 0.5, "risk 30/20 pyr3"),
    (0.40, 0.30, 3, 0.5, "risk 40/30 pyr3"),
]:
